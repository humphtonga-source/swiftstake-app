    ...
    try {
      ...
      if (savedSession) {
        ...
        if (userExists) {
          ...
          setupNav(); initPlanning(); startNotifScheduler(); subscribeToChat(); subscribeToDataChanges(); startClock(); renderChatPane(); if(typeof initPushNotifications==="function") setTimeout(()=>initPushNotifications(sess.name, sess.shop||"admin"), 2000);
