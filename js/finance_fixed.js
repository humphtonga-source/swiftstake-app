...
function renderFinance() {
  ...
  <div class="card" style="border-color:rgba(245,158,11,0.3);">
    ...
    <input type="number" id="opening-cash-inp" class="fl-inp" placeholder="e.g. 5000" min="0" style="font-size:18px;font-weight:800;color:var(--gold);border-color:rgba(245,158,11,0.4);" oninput="if(this.value<0)this.value=0;S.shopData[activeShop].openingCash=N(this.value);recalc();syncReconOpening();" onblur="if(this.value<0)this.value=0;S.shopData[activeShop].openingCash=N(this.value);saveShopState(activeShop);">
...
function syncReconOpening(){const ro=$('recon-opening'),oc=S.shopData[activeShop]&&S.shopData[activeShop].openingCash||0;if(ro&&document.activeElement!==ro){ro.value=oc;doRecon();}}
function recalc() {
